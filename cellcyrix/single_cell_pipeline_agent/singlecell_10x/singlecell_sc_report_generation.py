...
def _require_openai():
    ...
    try:
        ...
        from cellcyrix.llm.clients import get_sync_openrouter
    except Exception as e:
        # Surface the real cause. This used to report only "cellcyrix.llm is
        ...
        raise RuntimeError(
            "cellcyrix.llm is required for LLM report sections, but importing it "
