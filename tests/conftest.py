...
``agentic_ai_wf/single_cell_pipeline_agent/singlecell_10x/celltype_consensus/``. The
...
# Package root first so ``agentic_ai_wf.*`` resolves; then the directory that holds
